...
#           )
        for(x,y,w,h) in faces:
            ...
            if (confidence < 60):
                ...
                # r_set=my_conn.execute("select * from registration where id =" + str(id) +"");
                cv2.putText(img,"Person Identified"+str(id),(x+5,y-5),font,1,(0, 255, 0),2)
            ...
            # print(reg)
                ...
                for row in record:
                            ...
                            status = row[8]
                            reg1 = row[9]
                            photoPath = r"C:/Users/suraj/OneDrive/Desktop/criminal_identification/profile images//" + Fullname + ".jpg"
                            ...
                            l7.image = render
                            l7.place(x=50, y=50)
                            l8 = tk.Label(frame_display, text="7. Status :"+str(status), 
                                           font=("Times new roman", 18, "bold"), bg="snow")
                            l8.place(x=300, y=350)
                            l9 = tk.Label(frame_display, text="8. Register No :"+str(reg1), 
                                           font=("Times new roman", 18, "bold"), bg="snow")
...
button3 = tk.Button(frame_alpr, text="mask detect", command=mask, width=20, height=1, font=('times', 15, ' bold '),bg="yellow4",fg="white")
button3.place(x=10, y=150)

# button4 = tk.Button(frame_alpr, text="Display All Criminal Records", command=ID,width=20, height=1,bg="yellow4",fg="white", font=('times', 15, ' bold '))
