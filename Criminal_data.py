        ...
        for(x,y,w,h) in faces:
            ...
            # print(reg)
                ...
                for row in record:
                            ...
                            status = row[8]
                            reg1 = row[9]
                            photoPath = r"C:/Users/suraj/OneDrive/Desktop/Original_Criminal_Identification/profile images/" + Fullname + ".jpg"
...
button4 = tk.Button(frame_alpr, text="Mask detection", command=mask,width=20, height=1,bg="yellow4",fg="white", font=('times', 15, ' bold '))
button4.place(x=10, y=450)

exit = tk.Button(frame_alpr, text="Exit", command=window, width=20, height=1, font=('times', 15, ' bold '),bg="red",fg="white")
exit.place(x=10, y=530)
